...
public class Skill800 : DefaultSkill
{
    ...
    protected override void Init()
    {
        ...
        _skillNum = 800;
        //transform.position = _ownerCc.transform.position + new Vector3(-2.5f, 0.5f, -1f);
        transform.position = new Vector3(((_ownerCc.transform.position + TargetPos) / 2).x, 0.5f , ((_ownerCc.transform.position + TargetPos) / 2).z);
